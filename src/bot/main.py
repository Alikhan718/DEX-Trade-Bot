...
from .handlers import start, wallet, smart_money, help, buy, rugcheck, copy_trade, sell, settings, referral_system, withdraw, positions
...
class SolanaDEXBot:
    ...
    def _register_handlers(self):
        ...
        self.dp.include_router(withdraw.router)
        self.dp.include_router(positions.router)
