...
def analyze_transaction(tx_data: GetTransactionResp) -> None:
    ...
    for mint, change_data in changes.items():
        ...
        print("DETECTION OF TRANSACTION (RAYDIUM OR PUMPFUN)")
        print(mint)
        is_it_raydium = 'So11111111111111111111111111111111111111112' == str(mint)
        print("IS IT RAYDIUM? - " + str(is_it_raydium))

        if is_it_raydium:  # RAYDIUM
            print("OKAY IT'S RAYDIUM")
